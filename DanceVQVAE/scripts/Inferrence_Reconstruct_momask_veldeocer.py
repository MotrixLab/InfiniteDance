...
# 定义命令行参数
parser.add_argument('--checkpoint_path', type=str, default='/data1/hzy/HumanMotion/T2M-GPT_mofea264/output/exp_momask_alldata_mofea264_250425_1522/net_best_loss.pth',
...
parser.add_argument('--mean_file', type=str, default='/data1/hzy/HumanMotion/All_mofea/Mean.npy',
                    help='File name for mean values')
parser.add_argument('--std_file', type=str, default='/data1/hzy/HumanMotion/All_mofea/Std.npy',
                    help='File name for standard deviation values')
parser.add_argument('--motion_path', type=str, default='/data1/hzy/GVHMR/good/joints/mofea264',
                    help='File name for motion data')
parser.add_argument('--motion_file', type=str, default='/data1/hzy/GVHMR/good/joints/mofea264')
...
output_dir = "/data1/hzy/HumanMotion/All_mofea/ourData_smplx_22_smooth/joint_vecs264_vel"
...
for motion in tqdm(motion_files, desc="Processing motions", unit="file"):
    file_name = os.path.basename(motion)
    ...
    # 预测
    with torch.no_grad():
        # x_out,x_xz_vel_out,x_rot_out, commit_loss, perplexity, utilization_stats

        pred_motion,pred_motion_xz,_, _, _, _ = net(motion_tensor)
