...
# 定义命令行参数
parser.add_argument('--checkpoint_path', type=str, default='/data1/hzy/HumanMotion/T2M-GPT_mofea264/output/exp_momask_finedance_mofea264_250625_1103/net_best_fid.pth',
                    help='File name for motion data')
parser.add_argument('--data_root', type=str, default='/data1/hzy/HumanMotion/InfiniteDance/All_mofea/FineDance',
                    help='Root directory for data')
parser.add_argument('--mean_file', type=str, default='/data1/hzy/HumanMotion/InfiniteDance/All_mofea/FineDance/Mean.npy',
                    help='File name for mean values')
parser.add_argument('--std_file', type=str, default='/data1/hzy/HumanMotion/InfiniteDance/All_mofea/FineDance/Std.npy',
                    help='File name for standard deviation values')
parser.add_argument('--motion_path', type=str, default='/data1/hzy/HumanMotion/InfiniteDance/All_mofea/FineDance/new_joint_vecs264/test',
                    help='File name for motion data')
...
output_dir = f"{args.data_root}/test_mofea264_{name}/{current_time}"
...
# 设置参数
gt_root = "/data1/hzy/HumanMotion/InfiniteDance/All_mofea/FineDance/new_joint_vecs264"
pred_root = output_dir

# 调用 metrics_finedance.py 并传递参数
result = subprocess.run(
    [
        "python", "/data1/hzy/HumanMotion/Bailando/utils/metrics_finedance.py",
        "--gt_root", gt_root,
        "--pred_root", pred_root
    ],
