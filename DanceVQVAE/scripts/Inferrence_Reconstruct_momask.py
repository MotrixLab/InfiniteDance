...
# 定义命令行参数
parser.add_argument('--checkpoint_path', type=str, default='/data1/hzy/HumanMotion/T2M-GPT_mofea264/output/exp_momask_finedance_mofea264_250402_1621/net_best_fid.pth',
...
parser.add_argument('--motion_path', type=str, default='/data1/hzy/HumanMotion/All_mofea/FineDance/new_joint_vecs264/test',
                    help='File name for motion data')
...
for motion in tqdm(motion_files, desc="Processing motions", unit="file"):
    ...
    # 预测
    with torch.no_grad():
        pred_motion, _, _, _ = net(motion_tensor)
