...
def evaluate_matching_score(args, motion_loaders, audio_batch, eval_wrapper):
    ...
    for motion_loader_name, motion_loader in motion_loaders.items():
        ...
        with torch.no_grad():
            ...
            #         # print(os.path.join('/data2/hzy/InfiniteDance/InfiniteDanceData/dance/motionembeding_s150_w600', seqnames[motionidx]+'.npy'))
            #         time.sleep(0.06)
            #         np.save(os.path.join('/data2/hzy/InfiniteDance/InfiniteDanceData/dance/motionembeding_s150_w600', seqnames[motionidx]+'.npy'), motion_embeddings[motionidx].cpu().numpy())
            #         ttttnum = ttttnum+1
            ...
            # sys.exit(0)      
                ...
                for motionidx in range(len(seqnames)):
                    ...
                    # 45服务器
                    motion_embeddings.append(np.load(os.path.join('/data2/hzy/InfiniteDance/InfiniteDanceData/dance/motionembeding_s150_w600', seqnames[motionidx]+'.npy')) )
...
def sliding_windows_with_repeat_padding(audio_data, win_size=600, stride=150):
    windows = []
    n = len(audio_data)
...
def retrieval_motion_from_audio(input_audio_file, win_size=600, slide=150, device=None, args=None, eval_motion_loaders=None, eval_wrapper=None):
...
def process_onefile(input_audio_file, args, win_size=600, slide=150, eval_motion_loaders=None, eval_wrapper=None):
...
if __name__ == '__main__':
    ...
    data_cfg = get_config("./checkpoints/AInterClip_Audio55Motion264/0930/train/bc256_s150l600_drop0.2_lr1e-4/datasets45.yaml").largedance    #_test    #
    evalmodel_cfg = get_config("./checkpoints/AInterClip_Audio55Motion264/0930/train/bc256_s150l600_drop0.2_lr1e-4/InterCLIP.yaml")
    ...
    if os.path.isfile(args.audiopath):
        process_onefile(args.audiopath, args=args, win_size=600, slide=150, eval_motion_loaders=eval_motion_loaders, eval_wrapper=eval_wrapper)
    else:
        ...
        for onefile in tqdm(selected_list_2):
            process_onefile(onefile, args=args, win_size=600, slide=150, eval_motion_loaders=eval_motion_loaders, eval_wrapper=eval_wrapper)
...
''''
tmux new -s r1/3
conda activate dance && CUDA_VISIBLE_DEVICES=5 python retrievalm2d_s150_w600.py --range 1/3 --savedir /data2/hzy/InfiniteDance/InfiniteDanceData/dance/retrieval_s150_l600 

tmux new -s r2/3
conda activate dance && CUDA_VISIBLE_DEVICES=6 python retrievalm2d_s150_w600.py --range 2/3 --savedir /data2/hzy/InfiniteDance/InfiniteDanceData/dance/retrieval_s150_l600 

tmux new -s r3/3
conda activate dance && CUDA_VISIBLE_DEVICES=7 python retrievalm2d_s150_w600.py --range 3/3 --savedir /data2/hzy/InfiniteDance/InfiniteDanceData/dance/retrieval_s150_l600 
