...
if __name__ == '__main__':
    data_cfg      = get_config("configs/datasets.yaml").largedance
    train_cfg     = get_config("configs/largedance/train.yaml")
    # evalmodel_cfg = get_config("configs/largedance/InterCLIP_RP516.yaml")
    evalmodel_cfg = get_config("configs/largedance/InterCLIP_music_bodyjoints.yaml")
